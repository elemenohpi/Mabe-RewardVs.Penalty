...
int main(int argc, const char *argv[]) {
  ...
  myfile.open (FileManager::outputPrefix+(string)"/"+"a_com.csv", std::ios_base::trunc);
  myfile2.open (FileManager::outputPrefix+(string)"/"+"b_com.csv", std::ios_base::trunc);
  myfile3.open (FileManager::outputPrefix+(string)"/"+"c_com.csv", std::ios_base::trunc);     

  myfile << "update" << ',' << "exp_num" << ',' << "ahhh" << "," << "ahhs" << "," << "ahhb" << "," << "ahss" << "," << "ahbb" << "," << "ahbs" << "," << "abhh" << "," << "abhs" << "," << "abhb" << "," << "abss" << "," << "abbs" << "," << "abbb" << "," << "ashh" << "," << "ashs" << "," << "ashb" << "," << "asss" << "," << "asbb" << "," << "asbs" << "\n";

  myfile2 << "update" << ',' << "exp_num" << ',' << "ahhh" << "," << "ahhs" << "," << "ahhb" << "," << "ahss" << "," << "ahbb" << "," << "ahbs" << "," << "abhh" << "," << "abhs" << "," << "abhb" << "," << "abss" << "," << "abbs" << "," << "abbb" << "," << "ashh" << "," << "ashs" << "," << "ashb" << "," << "asss" << "," << "asbb" << "," << "asbs" << "\n";

  myfile3 << "update" << ',' << "exp_num" << ',' << "ahhh" << "," << "ahhs" << "," << "ahhb" << "," << "ahss" << "," << "ahbb" << "," << "ahbs" << "," << "abhh" << "," << "abhs" << "," << "abhb" << "," << "abss" << "," << "abbs" << "," << "abbb" << "," << "ashh" << "," << "ashs" << "," << "ashb" << "," << "asss" << "," << "asbb" << "," << "asbs" << "\n";
