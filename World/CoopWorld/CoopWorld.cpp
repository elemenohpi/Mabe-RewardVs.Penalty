...
// cout<<"mids"<<endl;
			...
			{	
				...
				for (auto team : teams)
				{
					...
					if (ta[0] == HARVESTER and ta[1] == HARVESTER and ta[2] == HARVESTER)
					{
						ahhh++;
						bhhh++;
						chhh++;
					}
					else if (ta[0] == HARVESTER and ta[1] == HARVESTER and ta[2] == ATTACKER)
					{
						ahhs++;
						bhhs++;
						cshh++;
					}
					else if (ta[0] == HARVESTER and ta[1] == HARVESTER and ta[2] == BUILDER)
					{
						ahhb++;
						bhhb++;
						cbhh++;
					}
					else if (ta[0] == HARVESTER and ta[1] == BUILDER and ta[2] == HARVESTER)
					{
						ahhb++;
						bbhh++;
						chhb++;
					}
					else if (ta[0] == HARVESTER and ta[1] == BUILDER and ta[2] == ATTACKER)
					{
						ahbs++;
						bbhs++;
						cshb++;
					}
					else if (ta[0] == HARVESTER and ta[1] == BUILDER and ta[2] == BUILDER)
					{
						ahbb++;
						bbhb++;
						cbhb++;
					}
					else if (ta[0] == HARVESTER and ta[1] == ATTACKER and ta[2] == HARVESTER)
					{
						ahhs++;
						bshh++;
						chhs++;
					}
					else if (ta[0] == HARVESTER and ta[1] == ATTACKER and ta[2] == BUILDER)
					{
						ahbs++;
						bshb++;
						cbhs++;
					}
					else if (ta[0] == HARVESTER and ta[1] == ATTACKER and ta[2] == ATTACKER)
					{
						ahss++;
						bshs++;
						cshs++;
					}
					else if (ta[0] == BUILDER and ta[1] == HARVESTER and ta[2] == HARVESTER)
					{
						abhh++;
						bhhb++;
						chhb++;
					}
					else if (ta[0] == BUILDER and ta[1] == HARVESTER and ta[2] == ATTACKER)
					{
						abhs++;
						bhbs++;
						cshb++;
					}
					else if (ta[0] == BUILDER and ta[1] == HARVESTER and ta[2] == BUILDER)
					{
						abhb++;
						bhbb++;
						cbhb++;
					}
					else if (ta[0] == BUILDER and ta[1] == BUILDER and ta[2] == HARVESTER)
					{
						abhb++;
						bbhb++;
						chbb++;	
					}
					else if (ta[0] == BUILDER and ta[1] == BUILDER and ta[2] == ATTACKER)
					{
						abbs++;
						bbbs++;
						csbb++;
					}
					else if (ta[0] == BUILDER and ta[1] == BUILDER and ta[2] == BUILDER)
					{
						abbb++;
						bbbb++;
						cbbb++;
					}
					else if (ta[0] == BUILDER and ta[1] == ATTACKER and ta[2] == HARVESTER)
					{
						abhs++;
						bshb++;
						chbs++;
					}
					else if (ta[0] == BUILDER and ta[1] == ATTACKER and ta[2] == BUILDER)
					{
						abbs++;
						bsbb++;
						cbbs++;
					}
					else if (ta[0] == BUILDER and ta[1] == ATTACKER and ta[2] == ATTACKER)
					{
						abss++;
						bsbs++;
						csbs++;
					}
					else if (ta[0] == ATTACKER and ta[1] == HARVESTER and ta[2] == HARVESTER)
					{
						ashh++;
						bhhs++;
						chhs++;
					}
					else if (ta[0] == ATTACKER and ta[1] == HARVESTER and ta[2] == ATTACKER)
					{
						ashs++;
						bhss++;
						cshs++;
					}
					else if (ta[0] == ATTACKER and ta[1] == HARVESTER and ta[2] == BUILDER)
					{
						ashb++;
						bhbs++;
						cbhs++;
					}
					else if (ta[0] == ATTACKER and ta[1] == BUILDER and ta[2] == HARVESTER)
					{
						ashb++;
						bbhs++;
						chbs++;
					}
					else if (ta[0] == ATTACKER and ta[1] == BUILDER and ta[2] == ATTACKER)
					{
						asbs++;
						bbss++;
						csbs++;
					}
					else if (ta[0] == ATTACKER and ta[1] == BUILDER and ta[2] == BUILDER)
					{
						asbb++;
						bbbs++;
						cbbs++;
					}
					else if (ta[0] == ATTACKER and ta[1] == ATTACKER and ta[2] == HARVESTER)
					{
						ashs++;
						bshs++;
						chss++;
					}
					else if (ta[0] == ATTACKER and ta[1] == ATTACKER and ta[2] == BUILDER)
					{
						asbs++;
						bsbs++;
						cbss++;
					}
					else if (ta[0] == ATTACKER and ta[1] == ATTACKER and ta[2] == ATTACKER)
					{
						asss++;
						bsss++;
						csss++;			
			...
			myfile.open (FileManager::outputPrefix+(string)"/"+"a_com.csv", std::ios_base::app);
			myfile2.open (FileManager::outputPrefix+(string)"/"+"b_com.csv", std::ios_base::app);
			myfile3.open (FileManager::outputPrefix+(string)"/"+"c_com.csv", std::ios_base::app);			

			myfile << Global::update << ',' << exp_number << ',' << ahhh << "," << ahhs << "," << ahhb << "," << ahss << "," << ahbb << "," << ahbs << "," << abhh << "," << abhs << "," << abhb << "," << abss << "," << abbs << "," << abbb << "," << ashh << "," << ashs << "," << ashb << "," << asss << "," << asbb << "," << asbs << "\n";

			myfile2 << Global::update << ',' << exp_number << ',' << bhhh << "," << bhhs << "," << bhhb << "," << bhss << "," << bhbb << "," << bhbs << "," << bbhh << "," << bbhs << "," << bbhb << "," << bbss << "," << bbbs << "," << bbbb << "," << bshh << "," << bshs << "," << bshb << "," << bsss << "," << bsbb << "," << bsbs << "\n";

			myfile3 << Global::update << ',' << exp_number << ',' << chhh << "," << chhs << "," << chhb << "," << chss << "," << chbb << "," << chbs << "," << cbhh << "," << cbhs << "," << cbhb << "," << cbss << "," << cbbs << "," << cbbb << "," << cshh << "," << cshs << "," << cshb << "," << csss << "," << csbb << "," << csbs << "\n";
