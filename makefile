...
objectFiles/World_CoopWorld_CoopWorld.o: ./World/CoopWorld/CoopWorld.cpp ./World/CoopWorld/CoopWorld.h
	c++ -Wno-c++98-compat -w -Wall -std=c++14 -O3 -lpthread -pthread -c ./World/CoopWorld/CoopWorld.cpp -o objectFiles/World_CoopWorld_CoopWorld.o
